...
<?php
    ...
    $query="SELECT * FROM `movie` WHERE language='tamil'";
        ...
        <div class="outer-right">
                ...
                <div class="list" style="width:100%"; >
                    <ul style="float:left;background-color:black;color:white;text-align:center;">
                        ...
                        <li><a href="nowshowing-tamil.php" class="active" style="background-color:#FC0000;color:white;width:4cm;">Tamil</a></li>
