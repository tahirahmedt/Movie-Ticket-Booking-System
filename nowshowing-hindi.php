...
<?php
    ...
    $query="SELECT * FROM `movie` WHERE language='hindi'";
        ...
        <div class="outer-right">
                ...
                <div class="list" style="width:100%"; >
                    <ul style="float:left;background-color:black;color:white;text-align:center;">
                        ...
                        <li><a href="nowshowing-hindi.php" class="active" style="background-color:#FC0000;color:white;width:4cm;">Hindi</a></li>
                        <li><a href="nowshowing-kannada.php" style="background-color:white;color:black;width:4cm;">Kannada</a></li>
                        <li><a href="nowshowing-malayalam.php" style="background-color:white;color:black;width:4cm;">Malayalam</a></li>
                        <li><a style="background-color:white;color:black;width:4cm;">Tamil</a></li>
